...
namespace Archetype {
    public class Lich : PlayerArchetype {
        public Lich() : base(PLAYER_ARCHETYPE.Lich) {
            actions = new List<string>() { PlayerDB.Afflict_Action, PlayerDB.Poison_Action, PlayerDB.Seize_Object_Action, PlayerDB.Animate_Action, PlayerDB.Summon_Minion_Action, PlayerDB.Corrupt_Action };
