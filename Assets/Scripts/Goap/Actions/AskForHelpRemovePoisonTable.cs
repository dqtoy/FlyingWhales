...
public class AskForHelpRemovePoisonTable : GoapAction {
    ...
    public void AfterAskSuccess() {
        ...
        GoapPlanJob job = new GoapPlanJob("Remove Poison", new GoapEffect() { conditionType = GOAP_EFFECT_CONDITION.REMOVE_TRAIT, conditionKey = "Poisoned", targetPOI = targetTable });
