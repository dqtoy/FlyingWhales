    ...
    public override string ReactionToActor(Character witness, ActualGoapNode node) {
        ...
        if (target is Character) {
            if (witness.traitContainer.HasTrait("Coward")) {
                ...
                Character targetCharacter = target as Character;
                if (witness.opinionComponent.IsFriendsWith(actor) && !witness.traitContainer.HasTrait("Psychopath")) {
    ...
    public override string ReactionOfTarget(ActualGoapNode node) {
        ...
        if (target is Character) {
            ...
            if (targetCharacter.traitContainer.HasTrait("Coward")) {
                ...
                if (targetCharacter.opinionComponent.IsFriendsWith(actor) && !targetCharacter.traitContainer.HasTrait("Psychopath")) {
