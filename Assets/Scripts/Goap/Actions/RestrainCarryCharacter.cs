...
public class RestrainCarryCharacter : GoapAction {
    ...
    public RestrainCarryCharacter() : base(INTERACTION_TYPE.RESTRAIN_CARRY_CHARACTER) {
    ...
    //     AddPrecondition(new GoapEffect() { conditionType = GOAP_EFFECT_CONDITION.CANNOT_MOVE, conditionKey = "Disabler", targetPOI = poiTarget }, HasNonPositiveDisablerTrait);
