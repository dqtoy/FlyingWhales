...
public class PrayTileObject : GoapAction {
    ...
    protected override int GetBaseCost(Character actor, IPointOfInterest target, JobQueueItem job, object[] otherData) {
        ...
        return Ruinarch.Utilities.rng.Next(15, 56);
    }
    public override void AddFillersToLog(Log log, ActualGoapNode node) {
        base.AddFillersToLog(log, node);
        IPointOfInterest poiTarget = node.poiTarget;
        TileObject obj = poiTarget as TileObject;
        log.AddToFillers(poiTarget, Ruinarch.Utilities.NormalizeStringUpperCaseFirstLetters(obj.tileObjectType.ToString()), LOG_IDENTIFIER.TARGET_CHARACTER);
    }
    #endregion
    ...
    public void PrePraySuccess(ActualGoapNode goapNode) {
        ...
        goapNode.descriptionLog.AddToFillers(goapNode.poiTarget, Ruinarch.Utilities.NormalizeStringUpperCaseFirstLetters(obj.tileObjectType.ToString()), LOG_IDENTIFIER.TARGET_CHARACTER);
    }
