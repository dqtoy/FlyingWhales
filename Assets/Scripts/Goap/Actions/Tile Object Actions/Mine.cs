...
public class Mine : GoapAction {
    ...
    public void PreMineSuccess(ActualGoapNode goapNode) {
        ...
        currentState.AddLogFiller(null, ore.GetSupplyPerMine().ToString(), LOG_IDENTIFIER.STRING_1);
    ...
    public void PreTargetMissing(ActualGoapNode goapNode) {
        goapNode.action.states[goapNode.currentStateName].AddLogFiller(goapNode.actor.currentStructure.location, goapNode.actor.currentStructure.GetNameRelativeTo(goapNode.actor), LOG_IDENTIFIER.LANDMARK_1);
    }
