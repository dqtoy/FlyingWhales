...
public class GoapActionData {
    ...
    private RACE[] RacesThatCanDoAction(INTERACTION_TYPE goapType) {
        switch (goapType) {
            ...
            case INTERACTION_TYPE.EAT_PLANT: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, RACE.WOLF, RACE.SPIDER, RACE.DRAGON };
            case INTERACTION_TYPE.EAT_SMALL_ANIMAL: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, RACE.WOLF, RACE.SPIDER, RACE.DRAGON };
            case INTERACTION_TYPE.EAT_DWELLING_TABLE: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON };
            case INTERACTION_TYPE.CRAFT_ITEM: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, };
            case INTERACTION_TYPE.PICK_ITEM: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, RACE.WOLF, RACE.SPIDER, RACE.DRAGON };
            case INTERACTION_TYPE.SLEEP: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, };
            case INTERACTION_TYPE.ABDUCT_ACTION: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, };
            case INTERACTION_TYPE.CARRY_CHARACTER: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, RACE.WOLF, RACE.SPIDER, RACE.DRAGON };
            case INTERACTION_TYPE.DROP_CHARACTER: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, RACE.WOLF, RACE.SPIDER, RACE.DRAGON };
            case INTERACTION_TYPE.DAYDREAM: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, };
            case INTERACTION_TYPE.PLAY_GUITAR: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, };
            case INTERACTION_TYPE.CHAT_CHARACTER: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, };
            case INTERACTION_TYPE.RETURN_HOME: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, RACE.WOLF, RACE.SPIDER, RACE.DRAGON };
            case INTERACTION_TYPE.DRINK: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, };
            case INTERACTION_TYPE.SLEEP_OUTSIDE: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, RACE.WOLF, RACE.SPIDER, RACE.DRAGON };
            case INTERACTION_TYPE.REMOVE_POISON_TABLE: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, };
            case INTERACTION_TYPE.TABLE_POISON: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, };
            case INTERACTION_TYPE.PRAY: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, };
            case INTERACTION_TYPE.MAGIC_CIRCLE_PERFORM_RITUAL: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, };
            case INTERACTION_TYPE.DROP_SUPPLY: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, };
            case INTERACTION_TYPE.GET_FOOD: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, };
            case INTERACTION_TYPE.DROP_FOOD: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, };
            case INTERACTION_TYPE.TILE_OBJECT_DESTROY: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, RACE.WOLF, RACE.SPIDER, RACE.DRAGON };
            case INTERACTION_TYPE.ITEM_DESTROY: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, RACE.WOLF, RACE.SPIDER, RACE.DRAGON };
            case INTERACTION_TYPE.HUNT_ACTION: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, RACE.WOLF, RACE.SPIDER, RACE.DRAGON };
            case INTERACTION_TYPE.PLAY: return new RACE[] { RACE.SKELETON, RACE.WOLF, RACE.SPIDER, RACE.DRAGON, };
            case INTERACTION_TYPE.TRANSFORM_TO_WOLF: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, };
            case INTERACTION_TYPE.REVERT_TO_NORMAL: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, };
            case INTERACTION_TYPE.RESTRAIN_CHARACTER: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, };
            case INTERACTION_TYPE.FIRST_AID_CHARACTER: return new RACE[] { RACE.HUMANS, RACE.ELVES, };
            case INTERACTION_TYPE.CURE_CHARACTER: return new RACE[] { RACE.HUMANS, RACE.ELVES, };
            case INTERACTION_TYPE.CURSE_CHARACTER: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, };
            case INTERACTION_TYPE.DISPEL_MAGIC: return new RACE[] { RACE.HUMANS, RACE.ELVES, };
            case INTERACTION_TYPE.JUDGE_CHARACTER: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, };
            case INTERACTION_TYPE.REPORT_CRIME: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, };
            case INTERACTION_TYPE.FEED: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, RACE.WOLF, RACE.SPIDER, RACE.DRAGON };
            case INTERACTION_TYPE.DROP_ITEM: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, };
            case INTERACTION_TYPE.DROP_ITEM_WAREHOUSE: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, };
            case INTERACTION_TYPE.ASK_FOR_HELP_SAVE_CHARACTER: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, };
            case INTERACTION_TYPE.ASK_FOR_HELP_REMOVE_POISON_TABLE: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, };
            case INTERACTION_TYPE.STAND: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, };
            case INTERACTION_TYPE.SIT: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, };
            case INTERACTION_TYPE.NAP: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, };
            case INTERACTION_TYPE.BURY_CHARACTER: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, };
            case INTERACTION_TYPE.CARRY_CORPSE: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, };
            case INTERACTION_TYPE.REMEMBER_FALLEN: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, };
            case INTERACTION_TYPE.SPIT: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, };
            case INTERACTION_TYPE.REPORT_HOSTILE: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, };
            case INTERACTION_TYPE.INVITE_TO_MAKE_LOVE: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, };
            case INTERACTION_TYPE.MAKE_LOVE: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, };
            case INTERACTION_TYPE.DRINK_BLOOD: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, RACE.WOLF, RACE.SPIDER, RACE.DRAGON };
            case INTERACTION_TYPE.REPLACE_TILE_OBJECT: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, };
            case INTERACTION_TYPE.CRAFT_FURNITURE: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, };
            case INTERACTION_TYPE.TANTRUM: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, };
            case INTERACTION_TYPE.EAT_MUSHROOM: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, RACE.WOLF, RACE.SPIDER, RACE.DRAGON };
            case INTERACTION_TYPE.SPREAD_RUMOR_REMOVE_FRIENDSHIP: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, };
            case INTERACTION_TYPE.SPREAD_RUMOR_REMOVE_LOVE: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, };
            case INTERACTION_TYPE.BREAK_UP: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, };
            case INTERACTION_TYPE.SHARE_INFORMATION: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, };
            case INTERACTION_TYPE.WATCH: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, };
            case INTERACTION_TYPE.INSPECT: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, };
            case INTERACTION_TYPE.EAT_CHARACTER: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.WOLF, RACE.SPIDER, RACE.DRAGON };
            case INTERACTION_TYPE.HUNTING_TO_DRINK_BLOOD: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, };
            case INTERACTION_TYPE.ROAMING_TO_STEAL: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, };
            case INTERACTION_TYPE.PUKE: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, };
            case INTERACTION_TYPE.SEPTIC_SHOCK: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, };
            case INTERACTION_TYPE.CARRY: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, RACE.WOLF, RACE.SPIDER, RACE.DRAGON };
            case INTERACTION_TYPE.DROP: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, RACE.WOLF, RACE.SPIDER, RACE.DRAGON };
            case INTERACTION_TYPE.KNOCKOUT_CHARACTER: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, };
            case INTERACTION_TYPE.RITUAL_KILLING: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, };
            case INTERACTION_TYPE.RESOLVE_CONFLICT: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, };
            case INTERACTION_TYPE.DOUSE_FIRE: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, };
            case INTERACTION_TYPE.GET_WATER: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, };
            case INTERACTION_TYPE.ACCIDENT: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, RACE.WOLF, RACE.SPIDER, RACE.DRAGON };
            case INTERACTION_TYPE.STUMBLE: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, RACE.SKELETON, RACE.WOLF, RACE.SPIDER, RACE.DRAGON };
            case INTERACTION_TYPE.TRANSFORM_FOOD: return new RACE[] { RACE.HUMANS, RACE.ELVES, RACE.GOBLIN, RACE.FAERY, };
