...
public enum JOB_TYPE { NONE, UNDERMINE_ENEMY, TIREDNESS_RECOVERY_EXHAUSTED, HUNGER_RECOVERY_STARVING, HAPPINESS_RECOVERY_FORLORN, TIREDNESS_RECOVERY, HUNGER_RECOVERY, HAPPINESS_RECOVERY, REMOVE_TRAIT, RESTRAIN, OBTAIN_SUPPLY, OBTAIN_FOOD
        ...
        , BERSERK, PATROL, EXPLORE, OBTAIN_ITEM, WATCH, DROP, DEATH, HUNT_SERIAL_KILLER_VICTIM, INSPECT, RESOLVE_CONFLICT, REMOVE_FIRE, MISC, ATTEMPT_TO_STOP_JOB, MOVE_OUT, SUICIDE }
...
public enum CHARACTER_STATE { NONE, EXPLORE, PATROL, HUNT, STROLL, BERSERKED, STROLL_OUTSIDE, COMBAT, DOUSE_FIRE, MOVE_OUT }
...
public enum INTERVENTION_ABILITY { ACCESS_MEMORIES, INFLICT_LYCANTHROPY, INFLICT_KLEPTOMANIA, INFLICT_VAMPIRISM, INFLICT_UNFAITHFULNESS, INFLICT_CANNIBALISM, ZAP, JOLT, SPOOK, ENRAGE, DISABLE
...
public enum WORLD_EVENT { MILITARY_TRAINING, HARVEST, HOUSING_CONSTRUCTION, ITEM_PRODUCTION, SLAY_MONSTER, DESTROY_ARTIFACT, PROTECTION_RITUAL, MINE_SUPPLY, CULT_FOUNDATION, DESTROY_DEMON_STONE, RAID_MINE, SABOTAGE_FARM, CULTIST_DISCOVERED }
