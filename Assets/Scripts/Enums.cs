...
public enum JOB_TYPE { NONE, UNDERMINE_ENEMY, TIREDNESS_RECOVERY_EXHAUSTED, HUNGER_RECOVERY_STARVING, HAPPINESS_RECOVERY_FORLORN, TIREDNESS_RECOVERY, HUNGER_RECOVERY, HAPPINESS_RECOVERY, REMOVE_TRAIT, RESTRAIN, OBTAIN_SUPPLY, OBTAIN_FOOD
        ...
        , DESTROY, OBTAIN_FOOD_OUTSIDE, OBTAIN_SUPPLY_OUTSIDE, IMPROVE, COMBAT, BUILD_GODDESS_STATUE, DESTROY_PROFANE_LANDMARK, PERFORM_HOLY_INCANTATION, PRAY_GODDESS_STATUE,
}
...
public enum WORLD_EVENT_EFFECT { GET_FOOD, GET_SUPPLY, GAIN_POSITIVE_TRAIT, REMOVE_NEGATIVE_TRAIT, EXPLORE, COMBAT, DESTROY_LANDMARK }
