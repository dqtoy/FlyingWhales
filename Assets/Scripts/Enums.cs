...
public enum INTERACTION_TYPE {
    ...
    MOVE_TO_RETURN_HOME,
    EXPLORE_EVENT,
    MOVE_TO_IMPROVE_RELATIONS_EVENT,
    PATROL_ACTION,
    MOVE_TO_RECRUIT_ACTION,
    ...
    CHARACTER_FLEES,
    USE_ITEM_ON_SELF,
    MOVE_TO_CHARM_ACTION,
    MOVE_TO_ABDUCT_ACTION,
    MOVE_TO_STEAL_ACTION,
    MOVE_TO_HUNT_ACTION,
    FOUND_LUCARETH,
    FOUND_MAGUS,
    FOUND_BESTALIA,
    ...
    MOVE_TO_VISIT,
    TRANSFER_HOME,
    MOVE_TO_STEAL_ACTION_FACTION,
    STEAL_ACTION_FACTION,
    MOVE_TO_RECRUIT_FRIEND_ACTION_FACTION,
    RECRUIT_FRIEND_ACTION_FACTION,
    MOVE_TO_ASSASSINATE_ACTION_FACTION,
    ASSASSINATE_ACTION_FACTION,
    MOVE_TO_LOOT_ACTION,
    LOOT_ACTION,
    MOVE_TO_TAME_BEAST_ACTION,
    TAME_BEAST_ACTION,
    MOVE_TO_HANG_OUT_ACTION,
    HANG_OUT_ACTION,
    MOVE_TO_EXPLORE_EVENT_FACTION,
    EXPLORE_EVENT_FACTION,
    MOVE_TO_CHARM_ACTION_FACTION,
    CHARM_ACTION_FACTION,
    MOVE_TO_ARGUE_ACTION,
    ARGUE_ACTION,
    MOVE_TO_SCAVENGE_EVENT_FACTION,
    MOVE_TO_CURSE_ACTION,
    CURSE_ACTION,
    SCAVENGE_EVENT_FACTION,
    CRAFT_ITEM,
    MOVE_TO_RAID_EVENT_FACTION,
    RAID_EVENT_FACTION,
    BERSERK_ATTACK,
    MOVE_TO_MINE_ACTION,
    MINE_ACTION,
    MOVE_TO_OCCUPY_ACTION_FACTION,
    OCCUPY_ACTION_FACTION,
    MOVE_TO_HARVEST_ACTION,
    HARVEST_ACTION,
    SCRAP_ITEM,
    PATROL_ACTION_FACTION,
    MOVE_TO_GIFT_BEAST,
    GIFT_BEAST,
    CONSUME_LIFE,
    ...
    TORTURE_ACTION_NPC,
    REST_AT_HOME_ACTION,
    EAT_HOME_MEAL_ACTION,
    POISON_HOUSE_FOOD,
    FEED_PRISONER_ACTION,
    BOOBY_TRAP_HOUSE,
    STEAL_ACTION_NPC,
    ASSAULT_ACTION_NPC,
    CAMP_OUT_ACTION,
    ...
    MAKE_LOVE_ACTION,
    REMOVE_CURSE_ACTION,
    RESTRAIN_CRIMINAL_ACTION,
    USE_ITEM_ON_STRUCTURE,
    FIRST_AID_ACTION,
    PROTECT_ACTION,
    LOCATE_MISSING,
    CONSUME_PRISONER_ACTION,
    MOVE_TO_COURTESY_CALL,
    COURTESY_CALL,
    MOVE_TO_GIFT_ITEM,
    GIFT_ITEM,
    TRANSFORM_TO_WOLF,
