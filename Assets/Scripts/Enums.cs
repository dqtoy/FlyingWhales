...
public enum INTERVENTION_ABILITY { ACCESS_MEMORIES, INFLICT_LYCANTHROPY, INFLICT_KLEPTOMANIA, INFLICT_VAMPIRISM, INFLICT_UNFAITHFULNESS, SHARE_INTEL, ZAP, JOLT, SPOOK, ENRAGE, DISABLE
