...
public enum INTERVENTION_ABILITY { ACCESS_MEMORIES, INFLICT_LYCANTHROPY, INFLICT_KLEPTOMANIA, INFLICT_VAMPIRISM, INFLICT_UNFAITHFULNESS, INFLICT_CANNIBALISM, ZAP, JOLT, SPOOK, ENRAGE, DISABLE
        , RILE_UP, ABDUCT, PROVOKE, DESTROY, RAISE_DEAD, CLOAK_OF_INVISIBILITY, EXPLOSION, IGNITE, LURE, CURSED_OBJECT, LULLABY, INFLICT_AGORAPHOBIA, SPOIL, INFLICT_ALCOHOLIC,
}
