...
public class MarkOfTheWitch : SpecialToken {
    ...
    public MarkOfTheWitch() : base(SPECIAL_TOKEN.MARK_OF_THE_WITCH, 20) {
        //quantity = 1;
    ...
    public override bool CanBeUsedBy(Character sourceCharacter) {
        //return true;
        return sourceCharacter.gender == GENDER.FEMALE && sourceCharacter.characterClass.attackType == ATTACK_TYPE.MAGICAL && sourceCharacter.role.roleType != CHARACTER_ROLE.BEAST;
    }
    #endregion
