...
public class InduceGrudge : Interaction {
    ...
    private void InduceOption() {
        ...
        effectWeights.AddElement(Induce_Grudge_Successful, investigatorCharacter.job.GetSuccessRate());
        effectWeights.AddElement(Induce_Grudge_Fail, investigatorCharacter.job.GetFailRate());
        effectWeights.AddElement(Induce_Grudge_Critical_Fail, investigatorCharacter.job.GetCritFailRate());
