...
public class MinionPeaceNegotiation : Interaction {
    ...
    private void ProceedOption() {
        ...
        effectWeights.AddElement(Peace_Negotiations_Successful, explorerMinion.character.job.GetSuccessRate());
        effectWeights.AddElement(Peace_Negotiations_Failed, explorerMinion.character.job.GetFailRate());
