...
public class FoundMagus : Interaction {
    ...
    public override void CreateStates() {
        ...
        InteractionState magusFoundedState = new InteractionState(Magus_Founded, this);
        ...
        magusFoundedState.SetEffect(() => MagusFoundEffect(magusFoundedState));
    ...
    private void DoNothingOption() {
        SetCurrentState(_states[Magus_Founded]);
    }
    #endregion
    ...
    private void TurnSuccessEffect(InteractionState state) {
        ...
        _characterInvolved.FoundFaction("Magus", interactable.tileLocation.areaOfTile);
