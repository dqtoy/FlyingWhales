...
public class FactionUpgrade : Interaction {
    ...
    private void StopOption() {
        ...
        effectWeights.AddElement(Stop_Faction_Upgrade_Successful, investigatorCharacter.job.GetSuccessRate());
        effectWeights.AddElement(Stop_Faction_Upgrade_Fail, investigatorCharacter.job.GetFailRate());
    ...
    private void DisruptOption() {
        WeightedDictionary<string> effectWeights = new WeightedDictionary<string>();
        effectWeights.AddElement(Disrupt_Faction_Upgrade_Successful, investigatorCharacter.job.GetSuccessRate());
        effectWeights.AddElement(Disrupt_Faction_Upgrade_Fail, investigatorCharacter.job.GetFailRate());
