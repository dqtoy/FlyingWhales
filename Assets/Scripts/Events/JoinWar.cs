...
//        kingdomToAttack.DiscoverKingdom(this._candidateForAlliance.city.kingdom);
	...
	internal override void PerformAction(){
		...
		/*if (this.remainingDays <= 0) {
			...
			if (chanceForSuccess < successRate) {
				...
				KingdomRelationship relationship = this.startedBy.GetRelationshipWithKingdom (this.candidateForAlliance);
	...
	internal override void DoneCitizenAction(Citizen citizen){
        ...
        int successRate = 15;
        Kingdom kingdomOfCandidate = candidateForAlliance.city.kingdom;
		...
		if (chanceForSuccess < successRate) {
			//target king will start invasion plan
			KingdomRelationship relationship = startedByKingdom.GetRelationshipWithKingdom (kingdomOfCandidate);
