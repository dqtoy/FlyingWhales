namespace Events.World_Events {
    public class AttackDemonicRegion : WorldEvent {

        public AttackDemonicRegion() : base(WORLD_EVENT.ATTACK_DEMONIC_REGION) {
            eventEffects = new WORLD_EVENT_EFFECT[] { WORLD_EVENT_EFFECT.ATTACK_DEMONIC_REGION };
            description = "This mission will attack a demonic region.";
