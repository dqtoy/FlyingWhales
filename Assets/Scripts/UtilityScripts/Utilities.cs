...
public class Utilities : MonoBehaviour {
    ...
    public static INTERACTION_TYPE[] interactionPriorityList = new INTERACTION_TYPE[] {
        ...
        INTERACTION_TYPE.MOVE_TO_IMPROVE_RELATIONS,
        INTERACTION_TYPE.MOVE_TO_RECRUIT,
        INTERACTION_TYPE.MOVE_TO_CHARM,
        INTERACTION_TYPE.MOVE_TO_ABDUCT,
        INTERACTION_TYPE.MOVE_TO_STEAL,
        INTERACTION_TYPE.MOVE_TO_HUNT,
        INTERACTION_TYPE.MOVE_TO_SPREAD_UNDEATH,
        ...
        INTERACTION_TYPE.MINION_RECRUIT_CHARACTER,
        INTERACTION_TYPE.MINION_PEACE_NEGOTIATION,
