...
public class FoodPile : TileObject {
    ...
    public FoodPile(LocationStructure location) {
        ...
        advertisedActions = new List<INTERACTION_TYPE>() { INTERACTION_TYPE.OBTAIN_RESOURCE, INTERACTION_TYPE.DROP_FOOD, INTERACTION_TYPE.REPAIR_TILE_OBJECT, INTERACTION_TYPE.DESTROY_RESOURCE };
