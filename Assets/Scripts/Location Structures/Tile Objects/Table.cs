...
public class Table : TileObject {
    ...
    public Table(LocationStructure location) {
        ...
        poiGoapActions = new List<INTERACTION_TYPE>() {  INTERACTION_TYPE.DRINK, INTERACTION_TYPE.REMOVE_POISON, INTERACTION_TYPE.POISON, INTERACTION_TYPE.TILE_OBJECT_DESTROY, INTERACTION_TYPE.DROP_FOOD, INTERACTION_TYPE.REPAIR_TILE_OBJECT };
