...
public class PlayerCharacterItem : PooledObject, IDragParentItem {
    ...
    public void SetCharacter(ICharacter character) {
        ...
        if (_character == null) {
            ...
            portrait.GeneratePortrait(_character, (int)portrait.gameObject.GetComponent<RectTransform>().rect.width, true);
    ...
    public void UpdateMinionItem() {
        if (_character == null) {
            ...
            lvlLbl.text = "Lvl. " + _character.minion.lvl + " " + _character.minion.strType;
