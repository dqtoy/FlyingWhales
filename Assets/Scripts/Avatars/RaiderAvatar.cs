...
//	}
	void OnTriggerEnter2D(Collider2D other){
		if(other.tag == "Avatar"){
			if(this.gameObject != null && other.gameObject != null){
				if(other.gameObject.GetComponent<Avatar>().kingdom.id != this.raider.citizen.city.kingdom.id){
			...
			if(this.gameObject != null && other.gameObject != null){
				Kingdom kingdomOfGeneral = this.raider.citizen.city.kingdom;
